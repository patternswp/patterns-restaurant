 ...
 * @subpackage Patterns_Restaurant/includes/api
 */
 ...
 */
if ( ! class_exists( 'Patterns_Restaurant_Api' ) ) {

	/**
	 * Patterns_Restaurant_Api
	 *
	 * @package Patterns_Restaurant
	 * @since 1.0.1
	 */
	class Patterns_Restaurant_Api extends WP_REST_Controller {
		...
		public function __clone() {
			...
			_doing_it_wrong( __FUNCTION__, esc_html__( 'Cheatin&#8217; huh?', 'patterns-restaurant' ), '1.0.0' );
		}
